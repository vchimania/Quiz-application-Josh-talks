            ...
            {questions.map((_, index) => (
              <button
                ...
                className={`py-1 px-2 rounded text-center ${
                  currentQuestion === index ? 'bg-blue-950 text-white' : 'bg-gray-300 text-gray-700'
                }`}
        ...
        <div>
          ...
          {questions.map((question, index) => (
            <div key={index} className="mb-4">
              ...
              <p className='text-red-600 font-bold'>Your Answer: {selectedAnswers[index]}</p>
              <p className='text-green-600 font-bold'>Correct Answer: {question.correctAnswer}</p>
              <hr className="my-2" />
            </div>
          ))}
